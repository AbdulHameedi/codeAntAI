...
const SignInOptions = () => {
  ...
  return (
    <div className="relative h-[52px] md:h-[60px] text-[20px] font-medium">
      ...
      <button
        className={`${
          signInOption && "bg-[#1570EF] text-white border-[0px] relative"
        } border-2 h-full w-1/2 text-[#414651] rounded-md mr-[-5px] md:mr[-13px]`}
      ...
      <button
        className={`${
          !signInOption && "bg-[#1570EF] text-white border-[0px] relative"
        } text-[#414651]  border-2 rounded-md h-full w-1/2`}
